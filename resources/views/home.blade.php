        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <div class="card-columns">
              ...
              <div class="card">
                <img class="card-img-top" src="https://api.lorem.space/image/furniture?w=400&h=225"
                     alt="Card image cap">
                <div class="card-body">
              ...
              <div class="card">
                <img class="card-img-top" src="https://api.lorem.space/image/book?w=400&h=225"
                     alt="Card image cap">
                <div class="card-body">
                  <h5 class="card-title">Book</h5>
                  <a href="{{route('books.index')}}" class="card-link">Go</a>
                </div>
              </div>
            </div>
          </div>
