            ...
            <form method="POST" action="{{route('books.update', $book->id)}}" enctype="multipart/form-data">
              ...
              <div class="form-row">
                <div class="form-group col-md-6">
                  ...
                  <input type="text" class="form-control" name="title_book" id="title_book" value="{{$book->title_book}}" >
                </div>
                <div class="form-group col-md-6">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="content_book" id="content_book" value="{{$book->content}}">
              </div>
              <div class="form-row">
                <div class="form-group col-md-6">
              ...
              <div class="form-group">
                <p>current picture</p>
                <img class="img-thumbnail align-center" src="{{Storage::url($book->photo_book)}}" alt="photo_book">
              </div>
